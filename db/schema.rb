...
ActiveRecord::Schema.define(version: 20170428142432) do
  ...
  create_table "drivers", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["created_at"], name: "index_drivers_on_created_at", using: :btree
  end

  create_table "input_value_trucks", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
